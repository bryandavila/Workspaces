namespace Workpaces.Migrations
{
    ...
    public partial class AppSet : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        idUsuario_Id = c.String(maxLength: 128),
                        Sala_IdSala = c.Int(),
                    })
                .PrimaryKey(t => t.IdReserva)
                .ForeignKey("dbo.AspNetUsers", t => t.idUsuario_Id)
                .ForeignKey("dbo.Salas", t => t.Sala_IdSala)
                .Index(t => t.idUsuario_Id)
                .Index(t => t.Sala_IdSala);
                ...
                c => new
                    {
                        ...
                        Ubicacion = c.String(nullable: false, maxLength: 200),
                        DisponibilidadEquipo = c.String(nullable: false, maxLength: 500),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Reservas", "idUsuario_Id", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.Reservas", new[] { "idUsuario_Id" });
